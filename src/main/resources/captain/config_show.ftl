<div class="panel panel-success">
	<div class="panel-heading">Server Configuration<a class="btn btn-link" href="/ui/config/">Edit</a></div>
	<div class="panel-body">
		<ul class="list-group">
			...
			<li class="list-group-item"><b class="text-success">thread_num</b> interval=${config.threadNum()?c}</li>
